...
public class Cannon_FINAL : MonoBehaviour
{
    ...
    private void Fire()
    {
        Projectile projectileInstance = Instantiate(weapon.projectilePrefab, cannonProjectileOrigin.position, Quaternion.identity);
